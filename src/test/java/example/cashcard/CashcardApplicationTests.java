...
//	@DirtiesContext
	void shouldCreateACashCard() {
		...
		ResponseEntity<Void> createResp = restTemplate
				.withBasicAuth("sarah1", "abc123")
	...
	@Test
	void shouldReturnAllTheCashCard(){
		ResponseEntity<String> response = restTemplate
				.withBasicAuth("sarah1", "abc123")
...
//	}
	...
	@Test
	void shouldNotUpdateCashCardThatDoesNotExists(){
		CashCard cashCard = new CashCard(null, 19.99, null);
		HttpEntity<CashCard> httpEntity = new HttpEntity<>(cashCard);
		ResponseEntity<Void> response = restTemplate
				.withBasicAuth("sarah1","abc123")
				.exchange("/cashcards/989898",HttpMethod.PUT,httpEntity,Void.class);
		assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
	}
